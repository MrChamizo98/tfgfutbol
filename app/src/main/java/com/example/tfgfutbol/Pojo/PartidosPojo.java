...
public class PartidosPojo {
    ...
    public PartidosPojo(){}
    public PartidosPojo(String partidos_fecha, String partidos_jornada, String partidos_local, String partidos_resultado, String partidos_visitante,
    ...
    public PartidosPojo(String partidos_fecha, String partidos_local, String partidos_resultado, String partidos_visitante){
        this.partidos_fecha=partidos_fecha;
        this.partidos_equipo_local=partidos_local;
        this.partidos_resultado=partidos_resultado;
        this.partidos_equipo_visitante=partidos_visitante;
