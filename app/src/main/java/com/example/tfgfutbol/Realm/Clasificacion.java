...
public class Clasificacion extends RealmObject {
    ...
    public Clasificacion(int clasificacion_goles_favor, int clasificacion_goles_contra, int clasificacion_empatados,
